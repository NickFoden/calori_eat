...
import { editServing } from "../redux/actions/meal";
      ...
      <div>
        ...
        <div>
          <form onSubmit={this.onSubmit}>
            <select value={measureURI} onChange={this.onMeasureChange}>
              {measures.map((measure, i) => (
                <option key={i} value={measure.uri}>
                  {measure.label}
                </option>
              ))}
            </select>
            <input
              ...
              type="text"
            ></input>
            <select value={mealCategory} onChange={this.onMealCategoryChange}>
...
const mapDispatchToProps = (dispatch) => ({
  editServing: (uuid, fetchObj, mealCategory) =>
    dispatch(editServing(uuid, fetchObj, mealCategory)),
});
