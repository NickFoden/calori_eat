...
import { fetchServing } from "../../redux/actions/food";
...
class ServingForm extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.setState({ foodId: this.props.food.foodId }, () =>
      this.props.fetchServing({
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit}>
        <select onChange={this.onChangeServing} value={this.state.measureURI}>
